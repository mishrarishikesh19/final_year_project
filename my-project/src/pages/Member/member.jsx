...
const handleMembers = () => {
  ...
  return (
    <div className="text-black p`-2 h-[100vh] w-full">
      ...
      {/* block for back to dashbooard buton */}
      <Link to={"/dashboard"}>
        <ArrowBackIcon />
        Back to Dashboard{" "}
      </Link>
      ...
      <div className="mt-5 text-xl flex justify-between text-slate-900 ">
        ...
        {!isSearchModeOn ? (
          <div className="flex gap-5">
            ...
            <div
              className={
                "w-8 h-8 cursor-pointer border-2 flex items-center justify-center hover:text-write hover:bg-gradient-to-r  from-indigo-500  via-purple-500 to-pink-500 ${currentPage===1?'bg-gray-200 text-gray-400':null}"
              }
              onClick={() => {
                handlePrev();
              }}
            ...
            <div
              className={
                "w-8 h-8 cursor-pointer border-2 flex items-center justify-center hover:text-write hover:bg-gradient-to-r  from-indigo-500  via-purple-500 to-pink-500 ${currentPage===noOfPage?'bg-gray-200 text-gray-400':null}"
              }
              onClick={() => {
                handleNext();
              }}
