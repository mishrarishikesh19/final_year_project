...
const fetchMembership = async () => {
   try {
    ...
    const handleSwitchBtn= async ()=>{
        ...
        setStatus(statuss);
        setData(prev => ({...prev, status: statuss}));
    }
        ...
        <div className='mt-10 p-2'>
            <div className='w-full h-fit flex'>
                <div className='w-1/3 mx-auto'>
                    <img src={data?.profilePic} alt='profile' className='w-full mx-auto'/>
                </div>
                            ...
                            <div className='rounded-lg p-3 mt-5 mb-5 h-fit bg-slate-50 w-[100%]'>
                                <div className='w-full '>
                                    <div className='my-5'>
                                        ...
                                        <div className={`mt-3 rounded-lg p-3 border-slate-900 text-center w-1/2 mx-auto cursor-pointer hover:text-white hover:bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500`} onClick={()=>{handleRenewSaveBtn()}}>Save</div>
                                    </div>
                                </div>
                            </div>
                        ):null
