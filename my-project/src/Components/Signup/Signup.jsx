  ...
  <div className="w-full min-h-screen flex justify-center items-center px-4">
    ...
    <h2 className="text-3xl md:text-4xl font-bold text-center text-white mb-8">Register Your Gym</h2>
        ...
        <form className="space-y-2 md:space-y-3">
          ...
          {/* Register Button */}
          <button type="submit" className="w-full py-3 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold rounded-lg transition duration-300 shadow-md hover:shadow-indigo-500/40">Register</button>
